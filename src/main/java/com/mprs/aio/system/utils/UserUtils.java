...
import com.mprs.aio.base.utils.SpringUtil;
...
public class UserUtils {
	...
	private static SysRoleMapper sysRoleMapper = SpringUtil.getBean(SysRoleMapper.class);
	private static SysMenuMapper menuDao = SpringUtil.getBean(SysMenuMapper.class);
...
//			sysUser.setId(id);
//			user = sysUserMapper.get(sysUser);
//			if (user == null){
//				return null;
//			}
//			user.setRoleList(sysRoleMapper.loadRoleByUser(user));
...
//		SysUser user = (SysUser)CacheUtils.get(USER_CACHE, USER_CACHE_LOGIN_NAME_ + userName);
//		if (user == null){
//			user = sysUserMapper.get
//			if (user == null){
//				return null;
//			}
//			user.setRoleList(sysRoleMapper.get(user));
//			CacheUtils.put(USER_CACHE, USER_CACHE_ID_ + user.getId(), user);
//			CacheUtils.put(USER_CACHE, USER_CACHE_LOGIN_NAME_ + user.getLoginName(), user);
//		}
//		return user;
