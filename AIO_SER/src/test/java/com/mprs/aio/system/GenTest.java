...
//		//生成实体类  checked
//		super.outprint("com.mprs.aio.gen.model.GenExecuteResult", generator.createEntity(URL, genConfigInfo));
		//生成Dao   chedked
//		super.outprint("com.mprs.aio.gen.model.GenExecuteResult", generator.createDao(URL, genConfigInfo));
		//生成Service   checked
//		super.outprint("com.mprs.aio.gen.model.GenExecuteResult", generator.createService(URL, genConfigInfo));
		//生成Controller   checked
//		super.outprint("com.mprs.aio.gen.model.GenExecuteResult", generator.createController(URL, genConfigInfo));
		//生成mapper 映射文件
		super.outprint("com.mprs.aio.gen.model.GenExecuteResult", generator.createMapping(URL, genConfigInfo));
	}
